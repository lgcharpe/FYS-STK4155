...
# start_column = np.random.randint(0,m-1200)
# start_row = np.random.randint(0,n-2400)
# end_column = start_column + 1200
# end_row = start_row + 2400

# X_train = X[start_row:end_row,start_column:end_column]
# Y_train = Y[start_row:end_row,start_column:end_column]
# F_train = terrain1[start_row:end_row,start_column:end_column]

# x_k=4
# lam = 0.0001

# print(np.sum(terrain1))
# print(np.amin(terrain1))
# tot = 0
# for i in range(n):
#     for j in range(m):
#         tot += terrain1[i,j]
...
# print("%dth-order polynomial Model (Least Squares)" % x_k)
# MSE_5, R2_5, var_5, bias = OLS(X, Y, terrain1, X, Y, terrain1, k=x_k)
# print("The MSE is: %.05f; and the R2 is: %.02f" % (MSE_5, R2_5))
# print("The variance is: %.05f; and the bias: %.05f" % (var_5, bias))
# print("Test: %.05f" % (var_5 + bias))
...
# print("%dth-order polynomial Model (Ridge) with lamba: %.08f" % (x_k, lam))
# MSE_5R, R2_5R, var_5R, biasR, diff_MSE_5, diff_R2_5 = Ridge(X, Y, terrain1, X, Y, terrain1, lam=lam, k=x_k)
# print("The MSE is: %.05f; and the R2 is: %.02f" % (MSE_5R, R2_5R))
# print("The variance is: %.05f; and the bias: %.05f" % (var_5R, biasR))
# print("Test: %.05f" % (var_5R + biasR))
# print("The difference with sklearn: MSE: %.05f; R2: %.05f" % (diff_MSE_5, diff_R2_5))

# print("%dth-order polynomial Model (Lasso) with lambda: %.08f" % (x_k, lam))
# MSEL, R2L, varL, biasL = Lasso(X, Y, terrain1, X, Y, terrain1, lam=lam, k=x_k)
# print("The MSE is: %.05f; and the R2 is:  %.02f" % (MSEL, R2L))
# print("The variance is: %.05f; and the bias: %.05f" % (varL, biasL))
# print("Test: %.05f" % (varL + biasL))
